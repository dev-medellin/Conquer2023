...
function(t) {
    ...
    var e = Array.prototype.slice,
        ...
        a = n.height(),
        h = function() {
            for (var e = n.scrollTop(), i = o.height(), s = i - a, h = e > s ? s - e : 0, l = 0, c = r.length; l < c; l++) {
                var d = r[l],
                    p = d.stickyWrapper.offset().top - d.topSpacing - h;
                if (d.stickyWrapper.css("height", d.stickyElement.outerHeight()), e <= p) null !== d.currentTop && (d.stickyElement.css({
                    width: "",
                    position: "",
                    top: "",
                    "z-index": ""
                    ...
                    var u, m = i - d.stickyElement.outerHeight() - d.topSpacing - d.bottomSpacing - e - h;
                    if (m < 0 ? m += d.topSpacing : m = d.topSpacing, d.currentTop !== m) d.getWidthFrom ? u = t(d.getWidthFrom).width() || null : d.widthFromWrapper && (u = d.stickyWrapper.width()), null == u && (u = d.stickyElement.width()), d.stickyElement.css("width", u).css("position", "fixed").css("top", m).css("z-index", d.zIndex), d.stickyElement.parent().addClass(d.className), null === d.currentTop ? d.stickyElement.trigger("sticky-start", [d]) : d.stickyElement.trigger("sticky-update", [d]), d.currentTop === d.topSpacing && d.currentTop > m || null === d.currentTop && m < d.topSpacing ? d.stickyElement.trigger("sticky-bottom-reached", [d]) : null !== d.currentTop && m === d.topSpacing && d.currentTop < m && d.stickyElement.trigger("sticky-bottom-unreached", [d]), d.currentTop = m;
                    var g = d.stickyWrapper.parent();
                    d.stickyElement.offset().top + d.stickyElement.outerHeight() >= g.offset().top + g.outerHeight() && d.stickyElement.offset().top <= d.topSpacing ? d.stickyElement.css("position", "absolute").css("top", "").css("bottom", 0).css("z-index", "") : d.stickyElement.css("position", "fixed").css("top", m).css("bottom", "").css("z-index", d.zIndex)
                }
            }
        },
        l = function() {
        ...
        c = {
            init: function(e) {
                ...
                return this.each(function() {
                    var e = t(this),
                        n = e.attr("id"),
                        o = n ? n + "-" + s.wrapperClassName : s.wrapperClassName,
                    ...
                    i.center && h.css({
                        ...
                        float: "right"
                    }), i.stickyElement = e, i.stickyWrapper = h, i.currentTop = null, r.push(i), c.setWrapperHeight(this), c.setupChangeListeners(this)
                })
            },
            ...
            unstick: function(e) {
                return this.each(function() {
                    for (var e = t(this), s = -1, n = r.length; n-- > 0;) r[n].stickyElement.get(0) === this && (i.call(r, n, 1), s = n); - 1 !== s && (e.unwrap(), e.css({
                        width: "",
                        position: "",
                        top: "",
                        float: "",
    ...
    window.addEventListener ? (window.addEventListener("scroll", h, !1), window.addEventListener("resize", l, !1)) : window.attachEvent && (window.attachEvent("onscroll", h), window.attachEvent("onresize", l)), t.fn.sticky = function(i) {
...
function(t, e) {
    ...
    var o = function() {
            ...
            return e.loopArray = function(t, e) {
                ...
                return ";" === t.substring(t.length - 1) && (t = t.substring(0, t.length - 1)), t.split(";").forEach(function(t) {
                    var s = t.split(":");
                    e[i.replaceString(s[0])] = i.replaceString(s[1])
                })
                ...
                return e.src = "https://connect.facebook.net/" + window.gameforest.facebook.lang + "/sdk.js#xfbml=1&version=" + window.gameforest.facebook.version + "&appId=" + window.gameforest.facebook.id, i.id = "fb-root", s.className = "fb-comments", s.setAttribute("data-width", "100%"), s.setAttribute("data-numposts", "10"), s.setAttribute("data-href", window.location.href), document.querySelector(t).appendChild(s), document.getElementById(i.id) || (document.body.appendChild(e), document.body.appendChild(i)), !0
            }, e.vimeo = function(t) {
                t && this.loopArray(t, this.options);
                var e = this.options.autoplay ? this.options.autoplay : 1,
                    i = this.options.loop ? 1 : 0,
                    s = this.options.quality ? this.options.quality : "1080p";
                return "?autoplay=" + e + "&amp;muted=" + (this.options.mute ? this.options.mute : 0) + "&amp;quality=" + s + "&amp;loop=" + i
            }, e.youtube = function(t, e) {
                t && this.loopArray(t, this.options);
                var i = this.options.controls ? this.options.controls : 1,
                    s = this.options.autoplay ? this.options.autoplay : 1,
                    n = this.options.mute ? this.options.mute : 0,
                    o = this.options.loop ? this.options.loop + "&amp;playlist=" + e : 0;
                this.options.recommends && this.options.recommends;
                return "?rel=0&amp;autoplay=" + s + "&amp;controls=" + i + "&amp;mute=" + n + "&amp;start=" + (this.options.start ? this.options.start : 0) + "&amp;loop=" + o
            }, e.site = function() {
                var t = [];
    ...
    var p = "ya-carousel",
        u = "[" + p + "]",
        m = "owl-carousel",
        g = "owl-carousel-theme",
        f = "owl-height-100",
        _ = function(t) {
            function i(e) {
                var i;
                return (i = t.call(this) || this)._element = e, i._attr = e.getAttribute(p), i
            }
            n(i, t);
            var o = i.prototype;
            return o._option = function() {
                return this._attr && this.loopArray(this._attr, this.options), this.options
            }, o._add = function() {
                var t = Math.floor(100 * Math.random()),
                    i = m + "-" + t;
                return this._option(), this.options.height && this._element.classList.add(f), this._element.classList.add(g, i), e("." + i).owlCarousel({
    ...
    var v = "ya-disqus",
        ...
        w = function(t) {
            ...
            return n(e, t), e.prototype._get = function() {
    ...
    var b = "ya-embed",
        ...
        k = function(t) {
            function e(e) {
                var i;
                return (i = t.call(this) || this)._element = e, i._attr = e.getAttribute(b), i._title = e.getAttribute(E), i._length = e.getAttribute(C), i._item = e.querySelector("img"), i._embed = e.querySelector(M.EMBED), i._iframe = e.querySelector(M.IFRAME), i
            }
            n(e, t);
            var i = e.prototype;
            return i.caption = function() {
                ...
                if (t.className = "embed-caption", this._element.appendChild(t), this._title) {
                    var e = document.createElement("div");
                    e.className = A.TITLE, e.innerText = this._title, t.appendChild(e)
                }
                if (this._length) {
                    var i = document.createElement("div");
                    i.className = A.LENGTH, i.innerText = this._length, t.appendChild(i)
                }
            }, i._set = function() {
                return this._item.classList.add(A.ITEM), this._element.classList.add("embed", "embed-responsive", "embed-responsive-16by9"), (this._title || this._length) && this.caption(), !0
            }, i._remove = function() {
                return this._item.classList.add("animated", "fadeOut"), (this._title || this._length) && this._element.querySelector(M.CAPTION).classList.add("animated", "fadeOut"), !0
            }, i._add = function(t) {
                var e = document.createElement("iframe");
                return e.className = A.ITEM, e.src = this.video(t), this._element.classList.add("play"), this._remove(), this._element.appendChild(e)
            }, i._get = function() {
                var t = this;
    ...
    var L = window.path ? window.path : "plugins",
        z = ".fas",
        $ = ".far",
        T = ".fab",
        D = ".fal",
        O = {
            CSS: L + "/fontawesome/css/fontawesome.min.css",
            REGULAR: L + "/fontawesome/css/regular.min.css",
            BRAND: L + "/fontawesome/css/brands.min.css",
            SOLID: L + "/fontawesome/css/solid.min.css",
            LIGHT: L + "/fontawesome/css/light.min.css"
        },
        I = function() {
            function t() {
                this._stylesheet = document.createElement("link"), this._stylesheet.rel = "stylesheet", this._stylesheet.href = O.CSS
            }
            var e = t.prototype;
            return e._solid = function() {
                if (document.querySelector(z)) {
                    var t = document.createElement("link");
                    t.rel = "stylesheet", t.href = O.SOLID, document.head.appendChild(t)
                }
                return !0
            }, e._brand = function() {
                if (document.querySelector(T)) {
                    var t = document.createElement("link");
                    t.rel = "stylesheet", t.href = O.BRAND, document.head.appendChild(t)
                }
                return !0
            }, e._light = function() {
                if (document.querySelector(D)) {
                    var t = document.createElement("link");
                    t.rel = "stylesheet", t.href = O.LIGHT, document.head.appendChild(t)
                }
                return !0
            }, e._regular = function() {
                if (document.querySelector($)) {
                    var t = document.createElement("link");
                    t.rel = "stylesheet", t.href = O.REGULAR, document.head.appendChild(t)
                }
                return !0
            }, e._get = function() {
    ...
    document.addEventListener("DOMContentLoaded", function() {
        (document.querySelector(z) || document.querySelector(T) || document.querySelector($) || document.querySelector(D)) && I._init.call()
    });
    var N = "ya-lightbox",
        H = "[" + N + "]",
        q = {
        ...
        B = function(t) {
            function i(e) {
                var i;
                return (i = t.call(this) || this)._element = e, i._attr = e.getAttribute("href"), i._data = e.getAttribute(N), i._rel = e.getAttribute("rel"), i
            }
            n(i, t);
            var o = i.prototype;
            return o._add = function(t) {
                var e = this,
                    i = this._attr.includes("youtube.com/watch"),
                    s = this._attr.includes("twitch"),
                    n = document.createElement("div");
                return n.backdrop = document.createElement("div"), n.body = document.createElement("div"), n.item = document.createElement("div"), n.close = document.createElement("div"), n.className = q.LIGHTBOX, n.body.className = q.BODY, n.close.className = q.CLOSE, n.backdrop.className = q.BACKDROP, n.body.classList.add("animated", "fast", "fadeIn", "animate1"), n.backdrop.classList.add("animated", "fadeIn", "fast"), document.body.appendChild(n), n.appendChild(n.body), n.item.appendChild(n.close), n.appendChild(n.backdrop), this._rel ? this._gallery(n) : i || s ? this._video(n, t) : this._image(n), this._data && (this.loopArray(this._data, this.options), n.option = this.options, (n.option.disqus || n.option.facebook) && this._comments(n)), n.item.addEventListener("click", function(t) {
                    return t.preventDefault(), n.element.contains(t.target) || n.carousel && (n.element.contains(t.target) || n.carousel.contains(t.target)) || e._remove(n), !1
                }, !1), !0
            }, o._gallery = function(t) {
                var i = this;
                return t.item.className = q.ITEM + " ya-lightbox-gallery", t.element = document.createElement("img"), t.element.className = q.IMAGE, t.element.src = this._attr, t.carousel = document.createElement("div"), t.carousel.className = "owl-carousel owl-carousel-theme", t.body.appendChild(t.item), t.item.appendChild(t.carousel), t.carousel.appendChild(t.element), document.querySelectorAll(H + "[rel=" + this._rel + "]").forEach(function(e) {
                    i._attr !== e.getAttribute("href") && (t.element = document.createElement("img"), t.element.className = q.IMAGE, t.element.src = e.getAttribute("href"), t.carousel.appendChild(t.element))
                }), e(".owl-carousel-theme").owlCarousel({
                    loop: !0,
                    nav: !0,
                    items: 1
                }), !0
            }, o._video = function(t, e) {
                return t.item.className = q.ITEM, t.element = document.createElement("iframe"), t.element.className = q.IFRAME_ITEM, t.element.src = this.video(e), t.embed = document.createElement("div"), t.embed.className = q.IFRAME, t.body.appendChild(t.item), t.item.appendChild(t.embed), t.embed.appendChild(t.element), !0
            }, o._image = function(t) {
                return t.item.className = q.ITEM, t.element = document.createElement("img"), t.element.className = q.IMAGE, t.element.src = this._attr, t.body.appendChild(t.item), t.item.appendChild(t.element), !0
            }, o._comments = function(t) {
                return t.item.classList.add("ya-lightbox-comment"), t.comments = document.createElement("div"), t.comments.className = "ya-lightbox-comments", t.comment = document.createElement("div"), t.body.appendChild(t.comments), t.option.disqus && (t.comment.id = "disqus_thread", t.comment.setAttribute(q.DISQUS, ""), t.comments.appendChild(t.comment), this.disqus("[" + q.DISQUS + "]")), t.option.facebook && (t.comment.className = "fb-comments", t.comment.setAttribute(q.FACEBOOK, ""), t.comment.setAttribute("data-width", "100%"), t.comment.setAttribute("data-numposts", "10"), t.comments.appendChild(t.comment), this.facebook("[" + q.FACEBOOK + "]")), !0
    ...
    var R = {
        ...
        j = function() {
            function t() {
                this._element = document.querySelector(R.SEARCH), this._close = document.querySelector(R.CLOSE), this._icon = document.querySelector(R.ICON)
            }
            var i = t.prototype;
    ...
    document.addEventListener("DOMContentLoaded", function() {
        document.querySelectorAll(R.NAVBAR).forEach(function(t) {
            j._init.call(t)
        })
    });
    var Z = "ya-notify",
        ...
        F = function(t) {
            function e(e) {
                var i;
                return (i = t.call(this) || this)._element = e, i._attr = e.getAttribute(Z), i._title = e.getAttribute(W), i
            }
            n(e, t);
            var i = e.prototype;
    ...
    var V = {
        ...
        Q = function() {
            function t(t) {
                this._element = t, this._bar = t.querySelector(V.BAR), this._value = this._bar.getAttribute(V.VALUE)
            }
    ...
    var G = "ya-sticky",
        ...
        K = function(t) {
            function i(e) {
                var i;
                return (i = t.call(this) || this)._element = e, i._attr = e.getAttribute(G), i._top = document.querySelector(".site-header").offsetHeight, i._zindex = 7, i
            }
            n(i, t);
            var o = i.prototype;
            return o._option = function() {
    ...
    var X = "ya-style",
        ...
        J = function(t) {
            function e(e) {
                var i;
                return (i = t.call(this) || this)._element = e, i._attr = e.getAttribute(X), i.option = [], i
            }
            n(e, t);
            var i = e.prototype;
            return i._set = function(t) {
                ...
                this.loopArray(this._attr, this.option), this._element.style.cssText = this._set(this.option), this._element.removeAttribute(X)
            }, e._init = function() {
                new e(this)._get()
            }, s(e, null, [{
                key: "VERSION",
    ...
    var tt = "ya-svg",
        ...
        it = function() {
            function t(t) {
                this._element = t, this._attr = t.getAttribute(tt)
            }
            return t.prototype._get = function() {
    ...
    document.addEventListener("DOMContentLoaded", function() {
        document.querySelectorAll(et).forEach(function(t) {
            it._init.call(t)
        })
    });
    var st = function(t) {
        ...
        n(i, t);
        var s = i.prototype;
        return s._bootstrap = function() {
            e('[data-toggle="tooltip"]').tooltip(), e('[data-toggle="popover"]').popover()
        }, s._fixHeight = function() {
            var t = window.innerHeight - document.querySelector(".site-header").offsetHeight;
            document.querySelectorAll(".owl-carousel-item").forEach(function(e) {
                e.style.height = t + "px"
            })
        }, s._new = function() {
            this.site()
        }, s._load = function() {
            this._bootstrap(), this._new(), this._fixHeight()
        }, i._init = function() {
            (new i)._load()
        }, i
    }(o);
    document.addEventListener("DOMContentLoaded", function() {
        st._init.call()
    }), t.Background = d, t.Carousel = _, t.Disqus = w, t.Embed = k, t.Facebook = S, t.Icons = I, t.Lightbox = B, t.Navbar = j, t.Notify = F, t.Progress = Q, t.Sticky = K, t.Style = J, t.Svg = it, t.Theme = st, Object.defineProperty(t, "__esModule", {
        value: !0
    })
});